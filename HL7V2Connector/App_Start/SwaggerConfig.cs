                ...
                .EnableSwagger(c =>
                    {
                        ...
                        //
                        c.SingleApiVersion("v1", "HL7V2Connector")
                            .License(builder => { new LicenseBuilder().Name("MIT LICENSE"); })
                            .Description("Generic Parser for HL7 V2.x flat file.  Converts flat file to XML string");
